...
void FragmentViewer::loadImage(QString fn)
{
    ...
    this->fileName = fn;
    setWindowTitle(tr("Fragment Viewer - ") + fileName);
    statusBar()->showMessage(tr("File loaded"), 2000);
}

void FragmentViewer::loadImage(Image *_matImage, QImage _qImage, QString tt)
{
    matImage = _matImage;
    qImage = _qImage;
    imageLabel->setPixmap(QPixmap::fromImage(qImage));
...
void FragmentViewer::testMethod()
{
    cout << "\nTest a method ..." << endl;
    RGB df;
    df.R = df.G = df.B = 0;
    ...
    FragmentViewer *other = new FragmentViewer;
...
void FragmentViewer::zoomIn()
{
    scaleImage(1.25);
}

void FragmentViewer::zoomOut()
{
    scaleImage(0.8);
}

void FragmentViewer::normalSize()
{
    imageLabel->adjustSize();
    scaleFactor = 1.0;
}

void FragmentViewer::fitToWindow()
{
...
void FragmentViewer::gScaleHistogram()
{
...
void FragmentViewer::rgbHistogramCalc()
{
    cout << "\n RGB histogram." << endl;
...
void FragmentViewer::displayManualLandmarks()
{
...
void FragmentViewer::displayAutoLandmarks()
{
...
void FragmentViewer::binThreshold()
{
    cout << "\nBinary thresholding...\n";
...
void FragmentViewer::cannyAlgorithm()
{
    cout << "\nCanny Algorithm...\n";
    Segmentation tr;
    tr.setRefImage(*matImage);
...
void FragmentViewer::suzukiAlgorithm()
{
    cout << "\nSuzuki Algorithm...\n";
    Segmentation tr;
    tr.setRefImage(*matImage);
...
void FragmentViewer::lineSegmentation()
{
...
void FragmentViewer::robertFilter()
{
    cout << "\n Robert filter." << endl;
...
void FragmentViewer::sobelFilter()
{
    cout << "\n Sobel filter." << endl;
...
void FragmentViewer::erosionOperation()
{
...
void FragmentViewer::dilationOperation()
{
...
void FragmentViewer::openOperation()
{
    cout << "\n Open operation." << endl;
    Matrix<int> sbResult = SobelOperation(matImage->getGrayMatrix());
    sbResult = postSobel(sbResult);
...
void FragmentViewer::closeOperation()
{
...
void FragmentViewer::gHoughTransform()
{
...
void FragmentViewer::extractLandmarks()
{
...
void FragmentViewer::measureMBary()
{
...
void FragmentViewer::measureEBary()
{
    QMessageBox qmessage;
...
void FragmentViewer::dirAutoLandmarks()
{
...
void FragmentViewer::dirCentroidMeasure()
{
...
void FragmentViewer::dirGenerateData()
{
...
void FragmentViewer::sobelAndSIFT()
{
...
void FragmentViewer::cannyAndSIFT()
{
    cout << "\nLandmarks with contours (Sobel) and SIFT" << endl;
    QMessageBox msgbox;
...
void FragmentViewer::pcaiMethodViewer()
{
...
*/
void FragmentViewer::extractObject(int x, int y)
{
...
*/
void FragmentViewer::process4Quarters()
{
    Segmentation tr;
    tr.setRefImage(*matImage);
...
void FragmentViewer::createActions()
{
    createFileMenu();
    createViewMenu();
    createHelpMenu();
...
void FragmentViewer::createMenus()
{
...
void FragmentViewer::createToolBars()
{
...
void FragmentViewer::createStatusBar()
{
    statusBar()->showMessage(tr("Ready"));
}

void FragmentViewer::createFileMenu()
{
...
void FragmentViewer::createViewMenu()
{
...
void FragmentViewer::createHelpMenu()
{
...
void FragmentViewer::createSegmentationMenu()
{
...
void FragmentViewer::createLandmarksMenu()
{
...
void FragmentViewer::createFilterMenu()
{
...
void FragmentViewer::createPluginMenu()
{
...
void FragmentViewer::viewMenuUpdateActions()
{
...
void FragmentViewer::scaleImage(double factor)
{
...
void FragmentViewer::adjustScrollBar(QScrollBar *scrollBar, double factor)
{
    scrollBar->setValue(
                int(
...
void FragmentViewer::displayLandmarks(Image *image, std::vector<Point> lms, RGB color)
{
    Point lm;
    for (size_t i = 0; i < lms.size(); i++)
    {
