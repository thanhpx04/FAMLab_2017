...
# Generated by qmake (2.01a) (Qt 4.8.6) on: mar. févr. 7 11:46:36 2017
...
ICP.o: pht/ICP.cpp utils/Converter.h \
		imageModel/Point.h \
		imageModel/Line.h \
		imageModel/Matrix.h \
		imageModel/Image.h \
		...
		pht/SVD.h \
		pht/ICP.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ICP.o pht/ICP.cpp
...
SVDHouseholder.o: pht/SVDHouseholder.cpp utils/Converter.h \
		imageModel/Point.h \
		imageModel/Line.h \
		imageModel/Matrix.h \
		pht/SVDHouseholder.h \
		pht/Vector.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SVDHouseholder.o pht/SVDHouseholder.cpp
