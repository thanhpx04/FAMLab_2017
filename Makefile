#############################################################################
# Makefile for building: FAMLab_CI
# Generated by qmake (2.01a) (Qt 4.8.7) on: lun. nov. 13 13:17:36 2017
# Project:  FAMLab_CI.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++-64 CONFIG+=debug -o Makefile FAMLab_CI.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtOpenGL -I/usr/include/qt4 -I/usr/local/include -I/usr/X11R6/include -I. -I.
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib64 -lpng -L/usr/lib -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = io/JPEGReader.cpp \
		...
		MAELab.cpp \
		FAMLab_CI.cpp moc_FragmentItem.cpp \
...
$(TARGET): ui_MatchingFragmentWindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)
	{ test -n "$(DESTDIR)" && DESTDIR="$(DESTDIR)" || DESTDIR=.; } && test $$(gdb --version | sed -e 's,[^0-9][^0-9]*\([0-9]\)\.\([0-9]\).*,\1\2,;q') -gt 72 && gdb --nx --batch --quiet -ex 'set confirm off' -ex "save gdb-index $$DESTDIR" -ex quit '$(TARGET)' && test -f $(TARGET).gdb-index && objcopy --add-section '.gdb_index=$(TARGET).gdb-index' --set-section-flags '.gdb_index=readonly' '$(TARGET)' '$(TARGET)' && rm -f $(TARGET).gdb-index || true

Makefile: FAMLab_CI.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++-64 CONFIG+=debug -o Makefile FAMLab_CI.pro
...
compiler_moc_header_make_all: moc_FragmentItem.cpp moc_FragmentViewer.cpp moc_ImageLabel.cpp moc_ImageViewer.cpp moc_MatchingFragmentWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_FragmentItem.cpp moc_FragmentViewer.cpp moc_ImageLabel.cpp moc_ImageViewer.cpp moc_MatchingFragmentWindow.cpp
...
compiler_uic_make_all: ui_MatchingFragmentWindow.h
compiler_uic_clean:
	-$(DEL_FILE) ui_MatchingFragmentWindow.h
ui_MatchingFragmentWindow.h: ui/MatchingFragmentWindow.ui
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic ui/MatchingFragmentWindow.ui -o ui_MatchingFragmentWindow.h
...
FAMLab_CI.o: FAMLab_CI.cpp ui/MatchingFragmentWindow.h \
		ui/FragmentViewer.h \
		imageModel/Point.h \
		imageModel/Line.h \
		imageModel/Edge.h \
		...
		ui/FragmentItem.h \
		imageModel/Image.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o FAMLab_CI.o FAMLab_CI.cpp
